/* ============================================================================
   /projects/[id] — one project, as a page.
   ...
   client: the index at /projects sorts newest first, and the plate number
...
/* Shared with /clippings/[id]: both are one long read on a dressed plate,
   and they are the same furniture. Lifted out of this folder when the second
   one arrived. */
import '../../story.css';
...
/* Newest first. The dates are human strings like 'May 2026', so parse rather
   ...
   app/projects/page.tsx, and it has to stay the same table. */
...
export function generateMetadata({ params }: { params: { id: string } }): Metadata {
  ...
  return {
    ...
    description,
    /* Indexable since the site took the apex. It was noindex for as long as
       this was a rebuild living at /v2 behind the old one. */
